      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16">
          ...
          <div class="flex items-center gap-3">
            ...
            <a href="/investor/login" class="hidden sm:inline-flex items-center gap-2 bg-white/10 hover:bg-white/20 text-white px-4 py-2 rounded-lg text-sm font-medium transition-colors border border-white/10">
        ...
        <div id="mobile-menu" class="hidden md:hidden pb-4 border-t border-white/10 mt-2 pt-4">
          <nav class="flex flex-col gap-1">
            ...
            <a href="/investor/login" class="flex items-center gap-3 px-4 py-3 rounded-lg bg-white/10 text-white mt-2">
              <i data-lucide="log-in" class="w-5 h-5"></i>
              투자자 로그인
            </a>
            <a href="/investor/register" class="flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-white/10 text-gray-300 hover:text-white transition-all">
              <i data-lucide="user-plus" class="w-5 h-5"></i>
              투자자 회원가입
            </a>
            <a href="/broker/info" class="flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-white/10 text-gray-300 hover:text-white transition-all">
